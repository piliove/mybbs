...
<!--网页顶部end-->
	...
	<div id="main">
		...
		<!--内容部分start-->
		<div class="content">			
			<form action="/index.php?m=home&c=post&a=save&cid=<?=$_GET['cid']?>" method="post">
				<table height="60">
					<tr>
						...
						<select name="cid">
							...
							<option value="<?=$k?>" <?php if($k==$cid){echo "selected";} ?> ><?=$v?></option>
							<?php endforeach; ?>
						</select>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2">
							<input type="submit" value="发贴" style="width:100px;height:30px;cursor:pointer;background-color: LightSkyBlue;border-color: LightSkyBlue;border-radius: 2px;color:#fff;margin-left:55px;margin-right:10px;position: relative;">
