...
<!--网页顶部end-->
	...
	<div id="main">
		...
		<!--内容部分start-->
		<div class="content">			
			<form action="/index.php?m=home&c=Register&a=doRegister" method="post">
				<table align="center" width="300" height="60">
					...
					<tr>
						<td colspan="2"><input style="margin:5px;margin-left:80px;margin-right:60px;" type="submit" value="注册">
